## discovery-20260610-bug0018 — BUG-0018 alert eval SQL (hot pointer) **From:** PO **To:** TL **Bug:** BUG-0018 **Run:** `intake-20260609-ui-audit` **Next:** `/research` **Full:** `handoffs/archive/po-to-tl-pack-20260609-j.md` · BE–BF · UI-003
## discovery-20260609-bug0017 — BUG-0017 forecast recompute (hot pointer) **From:** PO **To:** TL **Bug:** BUG-0017 **Next:** DONE **Full:** `handoffs/archive/po-to-tl-pack-20260609-h.md` · AY–BD
