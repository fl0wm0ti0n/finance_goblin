...
`triad_hot_surface`: rollover units=2,1; po_to_tl mirror → `handoffs/archive/po-to-tl-pack-20260606-j.md`; --check exit 0; po_to_tl 556/500 (section cap 40/40 — hot pointer retained); state 1000/1000
